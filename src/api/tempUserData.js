...
export var users = [im, er, pt, rk, al, jo];
...
export var photos = [photo1, photo2, photo3, photo4, photo5, photo6, photo7,
...
export var photoOfUserModel = function(userId) {
